...
@include('common.errors')
    ...
    {{ Form::open(['class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'role' => 'form', 'method' => 'POST', 'route' => 'tour.store']) }}
        ...
        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
            {{ Form::label('title', trans('messages.des_tour'), ['class' => 'col-md-4 control-label']) }}
            <div class="col-md-6">
        ...
        <div class="form-group{{ $errors->has('number_user') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                {{ Form::text('number_user', old('number_user'), ['class' => 'form-control']) }}
            </div>
        ...
        <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                {{ Form::date('start_date', old('start_date'), ['id' => 'datepicker', 'class' => 'form-control']) }}
            </div>
        ...
        <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                {{ Form::date('end_date', old('end_date'), ['id' => 'datepicker', 'class' => 'form-control']) }}
            </div>
        ...
        <div class="form-group">
            <div class="col-md-6 col-md-offset-4">
                {{ Form::submit(trans('messages.create_tour'), ['class' => 'btn btn-primary btn-sm active']) }}
                <a href="{{ route('tour.index') }}" class="btn btn-secondary btn-sm active">{{ trans('messages.back') }}</a>
            </div>
        </div>
    {{ Form::close() }}
@endsection
